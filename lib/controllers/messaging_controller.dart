...
class MessagingController extends GetxController {
  ...
  Future<void> sendMessage(String receiverID,String message)async{
    ...
    _ref.collection('chat_room').doc(chatRoomID).collection('messages').add(newMessage.toMap());
  ...
  Stream<QuerySnapshot> getMessage(String userId , String otherUserID){
    ...
    return _ref.collection('chat_room').doc(chatRoomID).collection('messages').orderBy('timestamp',descending: false).snapshots();
