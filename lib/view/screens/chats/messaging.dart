  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: CustomText(text: 'userName', fontWeight: .w600, fontSize: 18, color: MyColors.black(context)),
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(onPressed: (){}, icon: Icon(Icons.add,color: MyColors.grey(context),)),


              SizedBox(

                  width: 260,
                  child: InputField(hintText: 'Enter Message')),


             IconButton(onPressed: (){}, icon: SvgPicture.asset(SvgImages.sendIcon,height: 24.h,width: 24.w,)),
