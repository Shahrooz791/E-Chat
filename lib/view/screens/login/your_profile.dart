                ...
                () => Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      CustomText(
                        text: controller.selectDate.value,
                        fontWeight: .w500,
                        fontSize: 14,
                        color: controller.selectDate.value != 'Select Date'
                            ? MyColors.black(context)
                            : MyColors.grey(context),
                      ),
                ...
                () => Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      CustomText(
                        text: controller.selectGender.value,
                        fontWeight: .w500,
                        fontSize: 14,
                        color: controller.selectGender.value != 'Select Gender'
                            ? MyColors.black(context)
                            : MyColors.grey(context),
                      ),
                ...
                return CustomButton(
                  ...
                  onTapped: () {
                    ...
                    if (controller.nameController.text.isNotEmpty &&
                        ...
                        controller.selectDate.value != 'Select Date' &&
                        controller.selectGender.value != 'Select Gender') {
